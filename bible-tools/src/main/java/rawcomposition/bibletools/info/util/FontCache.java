...
public class FontCache {
    ...
    private FontCache() {
        AssetManager am = BibleToolsApp.getAppContext().getResources().getAssets();
        String fileList[];
        try {
    ...
    public Typeface get(String fontName) {
        ...
        if (cache.containsKey(fontName)) {
            ...
            Typeface typeface = Typeface.createFromAsset(BibleToolsApp.getAppContext().getAssets(), FONT_DIR + "/" + fontFilename);
